                            ...
                            case "add": {
                                ...
                                switch (perm) {
                                    case "exit": {
                                        ...
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [exit] 권한을 주었습니다.");
                                        break;
                                    }
                                    case "entrance": {
                                        area.addPermission(player, region, entrance);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [entrance] 권한을 주었습니다.");
                                        break;
                                    }
                                    case "item_pick_up": {
                                        area.addPermission(player, region, item_pick_up);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [item_pick_up] 권한을 주었습니다.");
                                        break;
                                    }
                                    case "item_drop": {
                                        area.addPermission(player, region, item_drop);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [item_drop] 권한을 주었습니다.");
                                        break;
                                    }
                                    case "block_place": {
                                        area.addPermission(player, region, block_place);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [block_place] 권한을 주었습니다.");
                                        break;
                                    }
                                    case "block_break": {
                                        area.addPermission(player, region, block_break);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [block_break] 권한을 주었습니다.");
                                        break;
                                    }
                                    case "block_ignite": {
                                        area.addPermission(player, region, block_ignite);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [block_ignite] 권한을 주었습니다.");
                                        break;
                                    }
                                    case "hanging_place": {
                                        area.addPermission(player, region, hanging_place);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [hanging_place] 권한을 주었습니다.");
                                        break;
                                    }
                                    case "hanging_break": {
                                        area.addPermission(player, region, hanging_break);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [hanging_break] 권한을 주었습니다.");
                                        break;
                                    }
                                    case "bucket_fill": {
                                        area.addPermission(player, region, bucket_fill);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [bucket_fill] 권한을 주었습니다.");
                                        break;
                                    }
                                    case "bucket_empty": {
                                        area.addPermission(player, region, bucket_empty);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [bucket_empty] 권한을 주었습니다.");
                                        break;
                                    }
                                    case "projectile_launch": {
                                        area.addPermission(player, region, projectile_launch);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [projectile_launch] 권한을 주었습니다.");
                                        break;
                                    }
                                    case "interact": {
                                        area.addPermission(player, region, interact);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [interact] 권한을 주었습니다.");
                                        break;
                                    }
                                    case "bed_leave": {
                                        area.addPermission(player, region, bed_leave);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [bed_leave] 권한을 주었습니다.");
                                        break;
                                    }
                                    default: {
                            ...
                            case "remove": {
                                ...
                                switch (perm) {
                                    case "exit": {
                                        ...
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [exit] 권한을 제거했습니다.");
                                        break;
                                    }
                                    case "entrance": {
                                        area.removePermission(player, region, entrance);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [entrance] 권한을 제거했습니다.");
                                        break;
                                    }
                                    case "item_pick_up": {
                                        area.removePermission(player, region, item_pick_up);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [item_pick_up] 권한을 제거했습니다.");
                                        break;
                                    }
                                    case "item_drop": {
                                        area.removePermission(player, region, item_drop);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [item_drop] 권한을 제거했습니다.");
                                        break;
                                    }
                                    case "block_place": {
                                        area.removePermission(player, region, block_place);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [block_place] 권한을 제거했습니다.");
                                        break;
                                    }
                                    case "block_break": {
                                        area.removePermission(player, region, block_break);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [block_break] 권한을 제거했습니다.");
                                        break;
                                    }
                                    case "block_ignite": {
                                        area.removePermission(player, region, block_ignite);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [block_ignite] 권한을 제거했습니다.");
                                        break;
                                    }
                                    case "hanging_place": {
                                        area.removePermission(player, region, hanging_place);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [hanging_place] 권한을 제거했습니다.");
                                        break;
                                    }
                                    case "hanging_break": {
                                        area.removePermission(player, region, hanging_break);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [hanging_break] 권한을 제거했습니다.");
                                        break;
                                    }
                                    case "bucket_fill": {
                                        area.removePermission(player, region, bucket_fill);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [bucket_fill] 권한을 제거했습니다.");
                                        break;
                                    }
                                    case "bucket_empty": {
                                        area.removePermission(player, region, bucket_empty);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [bucket_empty] 권한을 제거했습니다.");
                                        break;
                                    }
                                    case "projectile_launch": {
                                        area.removePermission(player, region, projectile_launch);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [projectile_launch] 권한을 제거했습니다.");
                                        break;
                                    }
                                    case "interact": {
                                        area.removePermission(player, region, interact);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [interact] 권한을 제거했습니다.");
                                        break;
                                    }
                                    case "bed_leave": {
                                        area.removePermission(player, region, bed_leave);
                                        p.sendMessage("[" + region + "]" + " 구역의 " + "[" + player.getName() + "]" + " 구성원에게 [bed_leave] 권한을 제거했습니다.");
                                        break;
                                    }
                                    default: {
                                        p.sendMessage("권한을 찾지 못했습니다.");
